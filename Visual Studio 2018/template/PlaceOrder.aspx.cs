...
public partial class PlaceOrder : System.Web.UI.Page
{
    ...
    public void saveaddress()
    {
        ...
        String mycon1 = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\ProductDetails.mdf;Integrated Security=True";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            String updatepass = "insert into orderdetails(orderid,sno,productid,productname,price,quantity,dateoforder) values('" + Label3.Text + "'," + dt.Rows[i]["sno"] + "," + dt.Rows[i]["productid"] + ",'" + dt.Rows[i]["productname"] + "'," + dt.Rows[i]["price"] + "," + dt.Rows[i]["quantity"] + ",'" + Label3.Text + "')";
            String mycon1 = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\ProductDetails.mdf;Integrated Security=True";
            SqlConnection s = new SqlConnection(mycon1);
            s.Open();
            SqlCommand cmd1 = new SqlCommand();
        ...
        saveaddress();
        Response.Redirect("PlacedSuccessful.aspx");
    }
